...
class TelaPC(ctk.CTkToplevel):
    def __init__(self, master, controller):
        ...
        self.feedback_label.pack(pady=20, fill="x")

        # PC: 24 slots (4x6)
        self.pc_frame = ctk.CTkFrame(main_frame, fg_color="#23272b", border_color="#c62828", border_width=2, corner_radius=8)
        self.pc_frame.pack(padx=24, pady=(12,8), fill="both", expand=True)

        # Equipe na parte inferior
        equipe_box_frame = ctk.CTkFrame(main_frame, fg_color="#263238", border_color="#c62828", border_width=2, corner_radius=8)
        equipe_box_frame.pack(padx=24, pady=24, fill="x")
        ...
        ctk.CTkButton(main_frame, text="Fechar PC", font=("Arial", 13, "bold"),
            ...
            command=self.fechar).pack(pady=12)
    ...
    def redesenhar_widgets(self):
        for widget in self.pc_frame.winfo_children():
            widget.destroy()
        for widget in self.equipe_frame.winfo_children():
            widget.destroy()
